...
<body>
  <header>
    <div class="menu-top">
      ...
      <br>
      <div class="container">
  <h2>Últimos pedidos hoje</h2>
  <p>Busque por hora, Nome do produto ou Valor</p>  
  <input class="form-control" id="myInput" type="text" placeholder="Busque">
  <br>
  <ul class="list-group" id="myList">
    <li class="list-group-item">9:00 - Coxinha, Coca Cola, Halls - R$ 12</li>
    <li class="list-group-item">9:01 - 3 Coxinha, 2 Coca Cola Lata, Suco - R$ 22</li>
    <li class="list-group-item">9:10 - 2 X-Tudo, Sprite Garrafa de 500 ml, Fanta Garrafa de 500 ml - R$ 40</li>
        <li class="list-group-item">9:00 - Coxinha, Coca Cola, Halls - R$ 12, Avenida Sampanpaio Vidal 136 - Marília  SP</li>
    <li class="list-group-item">9:01 - 3 Coxinha, 2 Coca Cola Lata, Suco - R$ 22, Avenida João Ramalho 123 - Marília  SP</li>
    <li class="list-group-item">9:10 - 2 X-Tudo, Sprit Garrafa de 500 ml, Fanta Garrafa de 500 ml - R$ 40, Novo Oriente 200 - Oriente SP</li>
    <li class="list-group-item">9:20 - Pizza de Frango, Coca Cola 2L, 10 Bala - R$ 50, Rio Branco 500 - Marília SP</li>
    <li class="list-group-item">9:20 - Pizza de Frango, Coca Cola 2L, 10 Bala  - R$ 50</li>
    <li class="list-group-item">10:01 - Pizza de Frango, Coca Cola 2L, 10 Bala  - R$ 50</li>
  </ul> 
    <h2>Foi vendido um total de: R$ 174,00</h2>
  <br>
  <h2>O Horário mais atendido foi as 10:00</h2> 
</div>
