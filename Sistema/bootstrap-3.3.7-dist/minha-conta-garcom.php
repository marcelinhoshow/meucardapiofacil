        ...
        <div class="container">
         ...
         <div id="navbar3" class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-right">
                <li><a href="garcom-inicio.php">Cardápio</a></li>
                <li><a href="pedido-garcom.php">Pedidos</a></li>
                <li><a href="minha-conta-garcom.php">Minha Conta</a></li>
          </div>
  </header>
<div class="container">
...
<div class="columns" style="background-color: white;">
  <ul class="price">
    <li><h4>Nome:Garçon 1  <span class="glyphicon glyphicon-chevron-right" style="float: right;"></span></h4></li>
    <li><h4>E-mail:garçon@gmail.com <span class="glyphicon glyphicon-chevron-right" style="float: right;"></span></h4></li>
    <li><h4>Função:Garçon <span class="glyphicon glyphicon-chevron-right" style="float: right;"></span></h4></li>
