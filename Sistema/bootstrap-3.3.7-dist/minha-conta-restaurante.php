...
<div class="columns" style="background-color: white;">
  <ul class="price">
    <li><h4>Login:Restaurante 1  <span class="glyphicon glyphicon-chevron-right" style="float: right;"></span></h4></li>
    <li><h4>Nome:Restaurante 1  <span class="glyphicon glyphicon-chevron-right" style="float: right;"></span></h4></li>
    <li><h4>E-mail:restaurante@gmail.com <span class="glyphicon glyphicon-chevron-right" style="float: right;"></span></h4></li>
    <li><h4>Endereço:Endereço 1  <span class="glyphicon glyphicon-chevron-right" style="float: right;"></span></h4></li>
    <li><h4>Função:Tipos de comida <span class="glyphicon glyphicon-chevron-right" style="float: right;"></span></h4></li>
    <li><h4>CNPJ:Novo CNPJ <span class="glyphicon glyphicon-chevron-right" style="float: right;"></span></h4></li>
    <li><h4>Alterar Senha <span class="glyphicon glyphicon-chevron-right" style="float: right;"></span></h4></li>
  </ul>
</div>
</center>
</div>
